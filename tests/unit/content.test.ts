...
import { allLabs, allPages, allWorks } from 'content-collections'
...
describe('content collections', () => {
  ...
  it('pages exist for about and colophon', () => {
    expect(allPages.map((p) => p.slug).sort()).toEqual(['about', 'colophon'])
  })
