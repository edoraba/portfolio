...
- [ ] Lighthouse: add a mobile run to `lighthouserc.json` (performance at least 0.9), keep desktop. If TBT rises above 200ms, defer Matter further (import on first scroll) and split GSAP plugins per plate.
